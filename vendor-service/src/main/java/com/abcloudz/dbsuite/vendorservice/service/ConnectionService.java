...
public interface ConnectionService {
    ...
    ConnectionResponseDTO findByGuid(String vendorGuid, String connectionGuid, Locale locale);
    ConnectionResponseDTO create(String vendorGuid, ConnectionCreateRequestDTO request);
